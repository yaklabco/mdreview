...
## [0.3.0](https://github.com/yaklabco/mdreview/compare/v0.3.5...v0.3.0) (2026-03-22)
...
* **background:** add service worker and state management ([00fda15](https://github.com/yaklabco/mdreview/commit/00fda1538e2cb8071fb870ba10bb62fe2b6b60c8))
* **background:** update service worker with cache and log state ([a20bcb3](https://github.com/yaklabco/mdreview/commit/a20bcb37acf3d0b5c900e56e4ae63034df2b09c5))
* **branding:** update extension icons to window frame design ([5e7e1ae](https://github.com/yaklabco/mdreview/commit/5e7e1aeeab6819b8bd75b5f772dc96d6e29b2234))
* **branding:** update icons and fix version sync ([1751058](https://github.com/yaklabco/mdreview/commit/17510588d5c21eb6e70e612dd46923ac6c66cfd5))
* **ci:** add makefile build system and optimize ui ([f1ece96](https://github.com/yaklabco/mdreview/commit/f1ece96a86bbd4f91890fc33f527bd9405a18dd0))
* **ci:** creat a Makefile ([c642f28](https://github.com/yaklabco/mdreview/commit/c642f28a7a75f53040f33d628d47744f7b38851b))
...
* **content:** add content script and styles ([5981736](https://github.com/yaklabco/mdreview/commit/59817364660975bf7cd4b36b81d6567207239aed))
* **content:** add site blocklist controls ([cf167c6](https://github.com/yaklabco/mdreview/commit/cf167c6c585adeb26589e1c6d647a291ed9e5dc6))
* **content:** check blocklist before rendering markdown ([b30519d](https://github.com/yaklabco/mdreview/commit/b30519d97274b7c77c8c092fc8113ec63440a7d8))
* **content:** integrate progressive rendering and logging ([5a3296e](https://github.com/yaklabco/mdreview/commit/5a3296e8f2196220f3db21d1febad73c63bb551d))
* **content:** integrate table of contents into content script ([a765cee](https://github.com/yaklabco/mdreview/commit/a765cee430383b37bf7942b8f937d69222ec7600))
* **core:** add export controller and mermaid code persistence ([b7ee465](https://github.com/yaklabco/mdreview/commit/b7ee4655ce8c2f9ab89f080b4432a7bbdddb1a25))
* **core:** add HTML rendering configuration support ([7da9ba8](https://github.com/yaklabco/mdreview/commit/7da9ba83da7e79360f067a83c3d09b1848658499))
* **core:** add logging, caching, and worker infrastructure ([ac57684](https://github.com/yaklabco/mdreview/commit/ac57684ba0c5a60e4d9dfeb956522cec5be70f70))
...
* **core:** implement markdown rendering pipeline ([b494017](https://github.com/yaklabco/mdreview/commit/b494017c50f39a174cdec253cd62a19913f67f84))
* **core:** implement progressive hydration and file watcher ([2d0ef02](https://github.com/yaklabco/mdreview/commit/2d0ef025c32eebdc08c78322bc6621017cf820ee))
* **core:** strip original TOC when custom TOC enabled ([9703a40](https://github.com/yaklabco/mdreview/commit/9703a407d14fa33455303ee4f477cdf2c476e982))
* **core:** strip original TOC when custom TOC enabled ([38f2f55](https://github.com/yaklabco/mdreview/commit/38f2f556261a46a0ea383772fe59ff144877406f))
...
* **export:** add document export to DOCX and PDF with SVG diagrams ([198719e](https://github.com/yaklabco/mdreview/commit/198719ee063cda9f14451a30aa9e00a5f380abd6))
* **extension:** add manifest and assets ([f598491](https://github.com/yaklabco/mdreview/commit/f598491aca16cd59d396fa831e00ab9d06d2f46a))
...
* **options:** add attribution footer for consistency ([2f26149](https://github.com/yaklabco/mdreview/commit/2f26149f10baca0bbe516684408d277386eb214d))
* **options:** add blocklist management UI ([d93325d](https://github.com/yaklabco/mdreview/commit/d93325d875b42e4b09b9396790d676c5d9e41aca))
* **options:** add configurable TOC style option ([13d7dc9](https://github.com/yaklabco/mdreview/commit/13d7dc90d1e19bd4d02bb255b3c194772760f6d0))
...
* **popup:** add quick site blocking toggle ([769b37c](https://github.com/yaklabco/mdreview/commit/769b37c8b7c65a6eb1099f52c7eba6b4001eaf85))
* **popup:** move site block toggle to footer ([dd50310](https://github.com/yaklabco/mdreview/commit/dd5031077c35aaa39e2a94e66a31653dbe9f7e60))
...
* **renderer:** enhance render pipeline with mermaid and progressive features ([8aed9e2](https://github.com/yaklabco/mdreview/commit/8aed9e224bf060915cc43fb6bf99adfca854ef8e))
* **renderer:** optimize mermaid diagram rendering ([04ecc14](https://github.com/yaklabco/mdreview/commit/04ecc14f9706af796a9c04bd2a36e48f07a4bb00))
* **renderers:** add syntax and diagram rendering ([64d42d7](https://github.com/yaklabco/mdreview/commit/64d42d7f9a6275f8b166322a64deab1eeddbba7c))
...
* **theme:** implement theme initialization and application ([a7608e6](https://github.com/yaklabco/mdreview/commit/a7608e632582c8fb1dd91ae6a3fc651e2beed21a))
...
* **themes:** implement theme system ([67d037f](https://github.com/yaklabco/mdreview/commit/67d037f240451335cbc9fa066e9f0293750d7caf))
* **types:** add blockedSites preference for site filtering ([cd5998f](https://github.com/yaklabco/mdreview/commit/cd5998f4f622947b24410fd6afaca449573eb199))
...
* **types:** add export-related type definitions ([5061720](https://github.com/yaklabco/mdreview/commit/5061720eabbf3bcb173d19e7590bc1ea41b91b48))
* **types:** define application interfaces ([3f4b01a](https://github.com/yaklabco/mdreview/commit/3f4b01ae247c5788e9223db8249ef80c5128b468))
* **ui:** add export UI component and integration tests ([f671556](https://github.com/yaklabco/mdreview/commit/f671556719c8d64d53e8290adcfa9088e7ac4c8a))
* **ui:** add log level selector and dynamic version display ([b84cad7](https://github.com/yaklabco/mdreview/commit/b84cad79c6ee742f2d5b3519124ebf087af5dbd2))
* **ui:** add log level settings and popup improvements ([bdbaa5f](https://github.com/yaklabco/mdreview/commit/bdbaa5f78658f0be912fd11d68801b356f67931a))
* **ui:** add popup and options interfaces ([459ea00](https://github.com/yaklabco/mdreview/commit/459ea0015cdfef0289f645a0945b4a5bafead763))
* **ui:** add table of contents controls to popup and options ([7c8439c](https://github.com/yaklabco/mdreview/commit/7c8439c6a4c12ac82a9a445df729895afd170f69))
* **ui:** add table of contents styling and layout ([8f83ad5](https://github.com/yaklabco/mdreview/commit/8f83ad5afd8945a3b4ad73d223a1a9b219c811b1))
* **ui:** enhance settings and theme management ([5fcd240](https://github.com/yaklabco/mdreview/commit/5fcd240ede321d60560bb8eeb306771edd8fee27))
* **ui:** implement table of contents renderer ([cff69a0](https://github.com/yaklabco/mdreview/commit/cff69a0da5c459ff4db735ab052e9644a28db819))
* **ui:** implement table of contents with navigation and configuration ([82ea0db](https://github.com/yaklabco/mdreview/commit/82ea0db194e5c30d8dd4a8eb9321d67797a21651))
* **ui:** integrate export into popup, options, and content ([0747bdf](https://github.com/yaklabco/mdreview/commit/0747bdf7bc24d3f200c94d0a547daefc2a8b34d7))
* **utils:** add content collection and SVG conversion ([2044a30](https://github.com/yaklabco/mdreview/commit/2044a3006102c0276ca0f7c4c603a3c6c272c4d7))
* **utils:** add debug logging system ([5b3635c](https://github.com/yaklabco/mdreview/commit/5b3635cee3863dee629de815d8d0e3a63ed750b2))
* **utils:** add document generators for DOCX and PDF ([4d613a4](https://github.com/yaklabco/mdreview/commit/4d613a49b648193f7375cb2fc9c1048ce53221ff))
* **utils:** add security and file utilities ([bd1a8f1](https://github.com/yaklabco/mdreview/commit/bd1a8f1e79e6ea1be39539eff8ff403d6bc95e0a))
* **utils:** implement site blocklist pattern matching ([71ccb04](https://github.com/yaklabco/mdreview/commit/71ccb049b34f192f21546bfa909dfb4069dd481c))
...
* **ci:** disable npm publishing in semantic-release ([1c38404](https://github.com/yaklabco/mdreview/commit/1c384044e8d7f86c54b9e49357257439875e69a8))
* **ci:** disable npm publishing in semantic-release ([c7ee20b](https://github.com/yaklabco/mdreview/commit/c7ee20bde5ecf3cb56c6c8caf4ee9377b9a7aa6f))
...
* **content:** add null check for state in debug mode setter ([712be60](https://github.com/yaklabco/mdreview/commit/712be607e4c21dfa70f30d74a7e1a846abb3061f))
* **content:** ensure loading overlay visibility and re-enable auto-reload ([8c0a80d](https://github.com/yaklabco/mdreview/commit/8c0a80d1f6c7257f2c67e728ed940669a4c873b7))
* **content:** scope markdown styles to mdview ([98cf300](https://github.com/yaklabco/mdreview/commit/98cf300adf1a2279392906357e4af5d332f19ec4))
...
* **core:** resolve file scanner errors and rendering issues ([24c12d4](https://github.com/yaklabco/mdreview/commit/24c12d4b8cf8d05db633c5b241cd9fd42bfea97e))
* **css:** resolve styling conflicts and improve specificity ([0ecebca](https://github.com/yaklabco/mdreview/commit/0ecebca3e7665a3cefb4b49c47e10e37d15b1570))
* **deps:** resolve security vulnerabilities in mermaid-cli dependencies ([5a439cf](https://github.com/yaklabco/mdreview/commit/5a439cf4947e8e79d2664f147e98cfa900044099))
* **docs:** add branch parameter to github actions badges ([10a6262](https://github.com/yaklabco/mdreview/commit/10a62620dd2ec9dda7b489873a813760f11d8203))
* **docs:** add branch parameter to github actions badges ([5cd3658](https://github.com/yaklabco/mdreview/commit/5cd36584d0d1d12d1551b4ed22be3a2166f45350))
...
* **file-scanner:** add context invalidation detection with debug logging ([9084947](https://github.com/yaklabco/mdreview/commit/9084947484b74f1b984cf156112aafb35ae63c92))
* **file-scanner:** prevent infinite loop in file watcher initialization ([3ccb5d8](https://github.com/yaklabco/mdreview/commit/3ccb5d837e6b67a62ecce562b2436bd81e93f04e))
* **hooks:** remove deprecated husky shebang for v10 compatibility ([a4501ab](https://github.com/yaklabco/mdreview/commit/a4501ab371d44badce18402569bbae8dad54abf5))
* **lint:** resolve eslint errors in export modules ([197c628](https://github.com/yaklabco/mdreview/commit/197c628c6809937308c2c0ed9f9e8f92531fab53))
* **lint:** resolve type safety and async errors ([d038756](https://github.com/yaklabco/mdreview/commit/d03875672cc8c30328d6dba3fb0e68b34b46acf1))
* **mermaid:** correct SVG type for getBBox method calls ([b812d9b](https://github.com/yaklabco/mdreview/commit/b812d9bff8213f81105a2fe9a7a9f3c7b2d34841))
* **mermaid:** correct zoom, fit, and maximize controls ([22b7221](https://github.com/yaklabco/mdreview/commit/22b72219d67b56c02eaab8ad326cf0e58124bff0))
* **mermaid:** use global registry to preserve diagram code ([5c1ea1b](https://github.com/yaklabco/mdreview/commit/5c1ea1b9c7fbb5c0ddd312d1b34c0832c58afde2))
* **pdf:** add missing return statement in prepareSvgsForPrint ([5a885ee](https://github.com/yaklabco/mdreview/commit/5a885ee9520f757cf6d209a196dff5f617a61814))
* **popup:** ensure wildcard blocklist removal uses host string ([39f5804](https://github.com/yaklabco/mdreview/commit/39f580463b5d5a7142c3e5e0661a090606156aad))
* **renderer:** ensure mermaid theme updates dynamically ([3b5f424](https://github.com/yaklabco/mdreview/commit/3b5f42429d71f4d47a619bb8af3d8ecd39fd8c6e))
...
* resolve TypeScript build errors for release ([08df090](https://github.com/yaklabco/mdreview/commit/08df090ae484840b240e0f182f23234880628731))
* restore version to 0.4.2 after release-please tag migration ([5e9cc5b](https://github.com/yaklabco/mdreview/commit/5e9cc5b551ecb185bad4d044435f7805b9a95495))
* **section-splitter:** track code fence state to prevent false heading detection ([325a868](https://github.com/yaklabco/mdreview/commit/325a868b7accf076333dd837ff18ac40b0d5d8f4))
...
* **tests:** correct synchronous error mock in render pipeline test ([e997517](https://github.com/yaklabco/mdreview/commit/e99751786160ac995938658f666f7d42dda0bcdb))
...
* **test:** update test mocks for vitest 4.0 compatibility ([4567bae](https://github.com/yaklabco/mdreview/commit/4567bae7ac9cfbd085f734b47e0f188a17e771e1))
* **ui:** fix text issue with sequence diagrams in github light theme ([b0940ca](https://github.com/yaklabco/mdreview/commit/b0940ca7e9fcb038b8ce1e01a5069b65295bd9f6))
* **ui:** fix text issue with sequence diagrams in github light theme ([3dd63cd](https://github.com/yaklabco/mdreview/commit/3dd63cd558efdc19b47dc51e1c1bff9de45ca73e))
* **ui:** resolve uncessary padding because of progressive hydration ([e46da5f](https://github.com/yaklabco/mdreview/commit/e46da5f335d5284c29b19810c852d731f34796c2))
...
* improve code quality and establish CI pipeline ([62588e2](https://github.com/yaklabco/mdreview/commit/62588e25efc4841dc39a24db08ac5ede70093602))
* **logger:** replace console calls with debug logger ([d39f021](https://github.com/yaklabco/mdreview/commit/d39f0211a675ffb202895851779c49f51dc4bb8e))
...
* **popup:** optimize layout and add attribution footer ([4519922](https://github.com/yaklabco/mdreview/commit/4519922bb355d32587fa92941a565f35ce677ae6))
* **workers:** improve file protocol logging clarity ([05e6672](https://github.com/yaklabco/mdreview/commit/05e6672e6d9394a679f8a93d3df3d60cbd39f699))
* **workers:** remove unused file monitor worker ([334d5eb](https://github.com/yaklabco/mdreview/commit/334d5eba1495b5b428735c53493bd12316a5f3ea))


### Documentation

* add Chrome Web Store submission assets ([2b6329b](https://github.com/yaklabco/mdreview/commit/2b6329be882de5ea1babfa93db6edd0ae207e763))
* add feature showcase document ([19ebf6e](https://github.com/yaklabco/mdreview/commit/19ebf6e7326314a8aabec2872048b967dfbb786c))
...
* add privacy policy ([874a0e1](https://github.com/yaklabco/mdreview/commit/874a0e1045e5acf95815fb4c7d2fa01a178b5f41))
* **branding:** update readme logo images ([731d131](https://github.com/yaklabco/mdreview/commit/731d131a6f94b5d8a4fb6407c82f2c272c6e0728))
* **changelog:** fix version ordering ([bc89abc](https://github.com/yaklabco/mdreview/commit/bc89abc51b3642263a60f433c3b15b76b7616b50))
* **changelog:** remove duplicate 0.2.0 section ([2e2cfd5](https://github.com/yaklabco/mdreview/commit/2e2cfd5b698b77d8c88244a3a0ed86ba6751de88))
* **changelog:** remove manual unreleased section ([eaf770f](https://github.com/yaklabco/mdreview/commit/eaf770f71be1d6696e040f34f288da47469a246f))
* clean up changelog for release infrastructure reset ([db77062](https://github.com/yaklabco/mdreview/commit/db770626118251f361035d87a9edc9f1949a6b36))
* **contributing:** document git hooks for automated quality checks ([a03fdcf](https://github.com/yaklabco/mdreview/commit/a03fdcf996e1f56bd39d6f91d080de3937125b13))
...
* **readme:** document makefile build system ([e918871](https://github.com/yaklabco/mdreview/commit/e918871bc88f35647fa8d2f8b12a14574efb408c))
* **readme:** fix broken links and revert logo to original ([20951b6](https://github.com/yaklabco/mdreview/commit/20951b62e96596d1051558165c6746ccbe36ed63))
* **readme:** remove non-working ci badges ([efce24a](https://github.com/yaklabco/mdreview/commit/efce24a3caed32fd9d0e48aecf44a584ecc0eea3))
* **readme:** remove non-working ci badges ([e7d6157](https://github.com/yaklabco/mdreview/commit/e7d61577261166bdc021777fb3af33badb8c582e))
...
* remove support email from README.md ([ee674de](https://github.com/yaklabco/mdreview/commit/ee674de5e8c4c51afba03179d780c0c113acd75a))
...
* update documentation for export feature ([fd72b75](https://github.com/yaklabco/mdreview/commit/fd72b759e66796bdf092af8c56e23b8375287599))
* update logo in README ([5e4e0e4](https://github.com/yaklabco/mdreview/commit/5e4e0e4c2dbe86bc0edb8ac311c1827a6f0796f5))
* update project documentation ([b711d00](https://github.com/yaklabco/mdreview/commit/b711d00d8dfea9abe36418e75d8bee5d9fb64b9c))
* update README with TOC feature and improve layout ([2a7da59](https://github.com/yaklabco/mdreview/commit/2a7da59fd725972b037bc5a986b5890084eb81f9))


### Tests

* **background:** add service worker fetch error handling tests ([1950222](https://github.com/yaklabco/mdreview/commit/1950222d6031027457619a4c5e4b9ac3c01f98e0))
...
* **core:** add edge case tests for TOC stripper ([f0aeb81](https://github.com/yaklabco/mdreview/commit/f0aeb8162372021e38adb9a4d209ca7740131098))
* **core:** fix render-pipeline test mock for updateOptions ([6e0c0a2](https://github.com/yaklabco/mdreview/commit/6e0c0a21aaf3a912f8c9245298865be12b73da37))
* implement comprehensive unit test suite ([1c20954](https://github.com/yaklabco/mdreview/commit/1c2095417739b3c9817be2b690d9dda825f51b57))
* implement comprehensive unit test suite and fix fetch error handling ([29b59c9](https://github.com/yaklabco/mdreview/commit/29b59c91f2a98516b43b772bcbbb9b3238802636))
* **infra:** setup vitest configuration and helpers ([dae6937](https://github.com/yaklabco/mdreview/commit/dae6937fd58851cb0a67dd2a807f293d38ce658f))
* **unit:** implement core rendering tests ([c9ab68a](https://github.com/yaklabco/mdreview/commit/c9ab68a110b36d08eaaff18a229dba7b6b06b059))
* **utils:** add unit tests for blocklist functionality ([a90e897](https://github.com/yaklabco/mdreview/commit/a90e897506f6680144eb4fe72599185214d6f964))


### Build System

* add icon generation scripts ([c3c5890](https://github.com/yaklabco/mdreview/commit/c3c58904f5d72e7b130a24a7a508d35df4a0c34e))
* **deps:** add jsdom for testing environment ([530ff75](https://github.com/yaklabco/mdreview/commit/530ff759fcaa81697a4efb27176903d35653ea9d))
* fix release-please config for componentless v* tags ([fac6576](https://github.com/yaklabco/mdreview/commit/fac65762de7eceae27c03614fa7e9ce7094657b0))
* **manifest:** auto-sync version from package.json ([5c694ed](https://github.com/yaklabco/mdreview/commit/5c694edc3eb97e61e91e33b4f9f5519fa1a64e8c))
...
* remove component prefix from release-please tags ([9d787a0](https://github.com/yaklabco/mdreview/commit/9d787a0ec942be26642969215528a14f96d3dfee))
* remove package-name from release-please config ([6c4e0e5](https://github.com/yaklabco/mdreview/commit/6c4e0e58b432af9f3aed4368e26d63d92dd12b80))
* reset to v0.3.0 for clean release-please start ([30da434](https://github.com/yaklabco/mdreview/commit/30da43423b8fbb99c50fdca65e5da4e19a52f197))
* set empty component to disable release-please component mode ([89a5b50](https://github.com/yaklabco/mdreview/commit/89a5b506adac2d12f2a23a23bd9db72fa1a884d0))
* set last-release-sha to anchor release-please after tag migration ([d8a2b46](https://github.com/yaklabco/mdreview/commit/d8a2b4652172ce5dfe23342fa0cb407fa04af105))


### Continuous Integration

* add eslint workflow for continuous integration ([6dd61ef](https://github.com/yaklabco/mdreview/commit/6dd61efaf76f3a8edca28fb1abeda8f93a001172))
* add release-extension workflow ([3ebf34a](https://github.com/yaklabco/mdreview/commit/3ebf34a5950351a549663b271437c45afbce2572))
* add release-please configuration ([7675508](https://github.com/yaklabco/mdreview/commit/76755083523e51cfbfea35b35a054adac5116211))
* add release-please workflow ([c14e868](https://github.com/yaklabco/mdreview/commit/c14e8687142cc9c5d6c50dd562fe6196f28d98c3))
* add test execution to CI workflow ([2c881f2](https://github.com/yaklabco/mdreview/commit/2c881f2f386fb4741ec51bea687d480a9fdefecb))
* migrate to release-please for controlled releases ([7107b9a](https://github.com/yaklabco/mdreview/commit/7107b9a37951499ce6cfb0a6fb4a4260ffa423a0))
* remove semantic-release ([0c7a523](https://github.com/yaklabco/mdreview/commit/0c7a523ce6e26e20486b1aa7ed1d00fe2ddaed75))
* setup automated release pipeline and version sync ([8c8b477](https://github.com/yaklabco/mdreview/commit/8c8b4771c6d376134d7f19bfdbac2771b29ddba3))
* setup automated release pipeline and version sync ([e231093](https://github.com/yaklabco/mdreview/commit/e2310936e56ebae897100d4e4276787e937f8021))
